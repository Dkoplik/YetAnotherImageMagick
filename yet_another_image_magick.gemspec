...
Gem::Specification.new do |spec|
  ...
  spec.description = "This ruby gem allows you to open different raster-images formats (png, jpg...) and crop them, paint or bucket fill with our API."
  spec.homepage = "https://github.com/Dkoplik/YetAnotherImageMagick"
  spec.license = "MIT"
  spec.platform = Gem::Platform::RUBY
  spec.required_ruby_version = ">= 3.0.0"

  spec.files = Dir["README.md", "LICENSE.txt", "lib/**/*.rb", "lib/**/*.rake", "yet_another_image_magick.gemspec", ".github/*.md", "Gemfile", "Rakefile"]
